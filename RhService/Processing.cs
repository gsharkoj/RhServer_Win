...
namespace RhServer
{
    public class Processing
    {
            ...
            switch (answer)
            {
                ...
                case (int)ResultConnection.ok:
                    ...
                    if (cl != null)
                    {
                        ...
                        // 
                        client.server.WriteLog("Start view id=" + client.id_client.ToString() + "\tid_partner=" + client.id_client_partner.ToString() + "\tuser data=" + client.user_data);
                        cl.server.WriteLog("Start view id=" + cl.id_client.ToString() + "\tid_partner=" + cl.id_client_partner.ToString() + "\tuser data=" + cl.user_data);
                    ...
                    else
                    {
                        ...
                        data_answer = null;
                        cl.id_client_partner = 0;
                        client.server.WriteLog("Stop view id=" + client.id_client.ToString());
                    }
                    break;
                default:
        ...
        {
            Byte[] data = null;
            Byte[] data_answer = null;
            int count = ReadData(ref data);

            if (count > 0)
            {
                Client cl = client.server.GetClient(client.id_client_partner);
                data_answer = GetSimpleData(Command.set_size, data);
                cl.SendData(data_answer);
        ...
        public int SetImage()
        {
            ...
            else
            {
                ...
                if (cl_partner.is_view == false)
                    cl_partner.is_view = true;
            }
        ...
        public int SetStop()
        {
            ...
            if (count > 0)
            {
                ...
                if (cl != null)
                {
                    ...
                    client.server.WriteLog("Stop view id=" + client.id_client_partner.ToString());
                    client.id_client_partner = 0;
                    cl.id_client_partner = 0;
                }
            }
